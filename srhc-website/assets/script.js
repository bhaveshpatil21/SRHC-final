...
const specialists = [
  ["Diabetologist","Blood sugar, diabetes management & lifestyle care."],
  ["Neurologist","Headaches, migraine, epilepsy & nerve disorders."],
  ["Psychiatrist","Anxiety, depression & mental wellness support."],
  ["Gynaecologist","Women's health, maternity & reproductive care."],
  ["Paediatrician","Complete health care for infants & children."],
  ["Orthopaedic Surgeon","Bones, joints, fractures & sports injuries."],
  ["Cardiologist","Heart health, BP & cardiac screening."],
  ["Physiotherapist","Rehabilitation, mobility & pain relief."],
...
if(tg){
  tg.innerHTML = specialists.map(s=>`
    <div class="doc reveal">
      ...
      <div class="bd"><h3>Visiting Consultant</h3><div class="role">${s[0]}</div><p>${s[1]}</p></div>
    </div>`).join('');
}
